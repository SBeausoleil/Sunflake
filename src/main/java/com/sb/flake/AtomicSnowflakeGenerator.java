 ...
 */
public class AtomicSnowflakeGenerator extends AtomicFlakeGenerator implements Serializable {
    ...
    public AtomicSnowflakeGenerator(int workerId) {
        super(DEFAULT_EPOCH, workerId, RULES);
    }

    public AtomicSnowflakeGenerator(int workerId, Instant epoch) {
